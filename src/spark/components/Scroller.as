package spark.components
{
   ...
   public class Scroller extends SkinnableComponent implements IFocusManagerComponent, IVisualElementContainer
   {
      ...
      private static var _skinParts:Object = {
         "horizontalScrollBarFactory":false,
         "horizontalScrollBar":false,
         "verticalScrollBar":false,
         "verticalScrollBarFactory":false
      };
      ...
      private function ensureElementPositionIsVisible(param1:IVisualElement, param2:Rectangle = null, param3:Boolean = true, param4:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            _loc10_ = (Boolean(_loc8_)) && !_loc8_.resizeForSoftKeyboard && (Boolean(stage) && stage.softKeyboardRect.height > 0);
            if(_loc10_)
            {
      ...
      {
         var _loc3_:Number = this.mx_internal::pageThrowVelocityThreshold * Capabilities.screenDPI / 1000;
         if(this.canScrollHorizontally)
         {
            if(param1 < -_loc3_ || this.viewport.horizontalScrollPosition >= this.currentPageScrollPosition + this.viewport.width * this.mx_internal::pageDragDistanceThreshold)
            {
            ...
            else if(param1 > _loc3_ || this.viewport.horizontalScrollPosition <= this.currentPageScrollPosition - this.viewport.width * this.mx_internal::pageDragDistanceThreshold)
            {
         ...
         {
            if(param2 < -_loc3_ || this.viewport.verticalScrollPosition >= this.currentPageScrollPosition + this.viewport.height * this.mx_internal::pageDragDistanceThreshold)
            {
            ...
            else if(param2 > _loc3_ || this.viewport.verticalScrollPosition <= this.currentPageScrollPosition - this.viewport.height * this.mx_internal::pageDragDistanceThreshold)
            {
      ...
      override protected function createChildren() : void
      {
         ...
         if(Application.mx_internal::softKeyboardBehavior == "none")
         {
         ...
         switch(param1.type)
         {
            case MouseEvent.MOUSE_DOWN:
               ...
               if(this.captureNextMouseDown && (Math.abs(this.viewport.verticalScrollPosition - this.throwFinalVSP) > _loc3_ || Math.abs(this.viewport.horizontalScrollPosition - this.throwFinalHSP) > _loc3_))
               {
                  ...
                  this.touchScrollHelper.mx_internal::startScrollWatch(param1,this.canScrollHorizontally,this.canScrollVertically,Math.round(this.mx_internal::minSlopInches * Capabilities.screenDPI),mx_internal::dragEventThinning ? MAX_DRAG_RATE : NaN);
