package spark.components.supportClasses
{
   ...
   public class DropDownListBase extends List
   {
      ...
      {
         if(DropDownListBase.mx_internal::createAccessibilityImplementation != null)
         {
      ...
      mx_internal function positionIndexInView(param1:int, param2:Number = NaN, param3:Number = NaN, param4:Number = NaN, param5:Number = NaN) : void
      {
         ...
         var _loc6_:Point = dataGroup.layout.mx_internal::getScrollPositionDeltaToElementHelper(param1,param2,param3,param4,param5);
         if(_loc6_)
         {
      ...
      override mx_internal function findKey(param1:int) : Boolean
      {
         ...
         if(param1 >= 33 && param1 <= 126)
         {
            ...
            _loc4_ = this.isDropDownOpen ? int(this.mx_internal::userProposedSelectedIndex + 1) : selectedIndex + 1;
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(!this.dropDownController.processKeyDown(param1))
         {
            ...
            if(this.isDropDownOpen)
            {
               _loc4_ = this.mx_internal::userProposedSelectedIndex < NO_SELECTION ? NO_SELECTION : int(this.mx_internal::userProposedSelectedIndex);
            ...
            else if(dataProvider)
            {
               ...
               _loc4_ = caretIndex < NO_SELECTION ? NO_SELECTION : int(caretIndex);
               switch(_loc2_)
               {
                  ...
                  case NavigationUnit.PAGE_UP:
                     _loc3_ = _loc4_ == NO_SELECTION ? NO_SELECTION : int(Math.max(_loc4_ - mx_internal::PAGE_SIZE,0));
                     param1.preventDefault();
                     break;
