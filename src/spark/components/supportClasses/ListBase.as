package spark.components.supportClasses
{
   ...
   public class ListBase extends SkinnableDataContainer
   {
      ...
      {
         return layout ? layout.useVirtualLayout : this._useVirtualLayout;
      }
      ...
      override protected function partAdded(param1:String, param2:Object) : void
      {
         ...
         if(param2 == dataGroup)
         {
            if(this._useVirtualLayout && dataGroup.layout && dataGroup.layout.mx_internal::virtualLayoutSupported)
            {
      ...
      protected function commitSelection(param1:Boolean = true) : Boolean
      {
         ...
         if(!this.mx_internal::allowCustomSelectedItem || this.mx_internal::_proposedSelectedIndex != mx_internal::CUSTOM_SELECTED_ITEM)
         {
            ...
            if(this.requireSelection && this.mx_internal::_proposedSelectedIndex == NO_SELECTION && dataProvider && dataProvider.length > 0)
            {
         ...
         if(this.mx_internal::dispatchChangeAfterSelection)
         {
            ...
            _loc5_.oldIndex = this.mx_internal::_selectedIndex;
