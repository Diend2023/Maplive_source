package spark.components
{
   ...
   public class List extends ListBase implements IFocusManagerComponent
   {
      ...
      public function get selectedItems() : Vector.<Object>
      {
         ...
         {
            _loc2_ = int(this.selectedIndices.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
      ...
      {
         if(List.mx_internal::createAccessibilityImplementation != null)
         {
      ...
      override protected function partAdded(param1:String, param2:Object) : void
      {
         ...
         if(param2 == this.scroller)
         {
            ...
            if((Boolean(_loc4_)) && _loc4_ !== ScrollPolicy.AUTO)
            {
      ...
      protected function commitMultipleSelection() : void
      {
         ...
         {
            _loc4_ = int(this._proposedSelectedIndices.length);
            _loc3_ = 0;
            while(_loc3_ < _loc4_)
            {
            ...
            _loc4_ = int(this._selectedIndices.length);
            _loc3_ = 0;
            while(_loc3_ < _loc4_)
            {
      ...
      override mx_internal function dataProviderRefreshed() : void
      {
         ...
         if(mx_internal::caretItem !== undefined && dataGroup && Boolean(dataGroup.dataProvider))
         {
      ...
      protected function mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 5;
         if(Math.abs(this.mx_internal::mouseDownPoint.x - _loc2_.x) > _loc3_ || Math.abs(this.mx_internal::mouseDownPoint.y - _loc2_.y) > _loc3_)
         {
      ...
      private function removeMouseHandlersForDragStart(param1:Event) : void
      {
         ...
         if(this.mx_internal::pendingSelectionOnMouseUp && !DragManager.isDragging)
         {
            if(getStyle("interactionMode") == InteractionMode.TOUCH)
            {
               _loc2_ = param1.target == this.mx_internal::mouseDownObject || this.mx_internal::mouseDownObject is DisplayObjectContainer && DisplayObjectContainer(this.mx_internal::mouseDownObject).contains(param1.target as DisplayObject);
               if(_loc2_)
               {
                  if(this.allowMultipleSelection)
                  {
