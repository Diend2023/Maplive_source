...
class PathSegmentsCollection
{
   ...
   public function PathSegmentsCollection(param1:String)
   {
      ...
      while(true)
      {
         ...
         _loc4_ = Number(param1.charCodeAt(this._charPos++));
   ...
   private function skipWhiteSpace(param1:String) : void
   {
      ...
      {
         _loc2_ = Number(param1.charCodeAt(this._charPos));
   ...
   private function getNumber(param1:Boolean, param2:Number, param3:String) : Number
   {
      ...
      var _loc7_:Number = Number(param3.charCodeAt(this._charPos));
      ...
      while(this._charPos < this._dataLength)
      {
         _loc7_ = Number(param3.charCodeAt(this._charPos));
