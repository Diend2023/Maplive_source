package spark.effects
{
   ...
   public class ThrowEffect extends Animate
   {
      ...
      {
         var _loc3_:int = param1 == 0 ? 0 : int(Math.log(0.01 / Math.abs(param1)) / Math.log(this.mx_internal::decelerationFactor));
         var _loc4_:int = param2 == 0 ? 0 : int(Math.log(0.01 / Math.abs(param2)) / Math.log(this.mx_internal::decelerationFactor));
