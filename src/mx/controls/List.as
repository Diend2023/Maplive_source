package mx.controls
{
   ...
   public class List extends ListBase implements IIMESupport
   {
         ...
         if(itemsNeedMeasurement)
         {
            ...
            if(isNaN(explicitRowHeight))
            {
               if(iterator)
               {
                  ...
                  _loc3_ = this.mx_internal::getMeasuringRenderer(iterator.current);
                  _loc4_ = 200;
                  ...
                  this.mx_internal::setupRendererFromData(_loc3_,iterator.current);
            ...
            {
               mx_internal::setColumnWidth(this.measureWidthOfItems(0,explicitRowCount < 1 ? defaultRowCount : explicitRowCount));
            }
         }
      }
      ...
      private function adjustVerticalScrollPositionDownward(param1:int) : Boolean
      {
         ...
         item = this.mx_internal::getMeasuringRenderer(iterator.current);
         ...
         while(h > 0 && more)
         {
            if(more)
            {
               ...
               this.mx_internal::setupRendererFromData(item,data);
      ...
      override public function measureWidthOfItems(param1:int = -1, param2:int = 0) : Number
      {
         ...
         while(i < count)
         {
            if(more)
            {
               ...
               if(!item)
               {
                  item = this.mx_internal::getMeasuringRenderer(data);
               }
      ...
      override public function set itemRenderer(param1:IFactory) : void
      {
         ...
         this.mx_internal::purgeMeasuringRenderers();
      }
      ...
      {
         this.mx_internal::setupRendererFromData(param1,param2);
      }
