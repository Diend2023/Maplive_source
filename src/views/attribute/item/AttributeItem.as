package views.attribute.item
{
   ...
   public class AttributeItem extends ItemRenderer
   {
      ...
      public function AttributeItem()
      {
         ...
         this.height = 26;
         this.mxmlContent = [this._AttributeItem_HGroup1_c()];
      }
      ...
      override public function set data(param1:Object) : void
      {
         ...
         if(param1)
         {
            this.pname.text = param1.name as String;
            this.pvalue.text = param1.value as String;
         }
      }
      ...
      private function _AttributeItem_HGroup1_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.verticalCenter = 0;
         _loc1_.mxmlContent = [this._AttributeItem_Label1_i(),this._AttributeItem_TextInput1_i()];
         if(!_loc1_.document)
         {
      ...
      private function _AttributeItem_Label1_i() : Label
      {
      ...
      private function _AttributeItem_TextInput1_i() : TextInput
      {
