package mx.core
{
   ...
   public class Application extends LayoutContainer
   {
      ...
      {
         if(param1 == this.controlBar && "dock" in param1 && Boolean(param1["dock"]))
         {
            this.mx_internal::dockControlBar(IUIComponent(param1),false);
         }
      ...
      public function addToCreationQueue(param1:Object, param2:int = -1, param3:Function = null, param4:IFlexDisplayObject = null) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc12_:int = 0;
         var _loc5_:int = int(this.creationQueue.length);
         var _loc6_:Object = {};
         ...
         {
            _loc9_ = int(this.creationQueue[_loc11_].index);
