package mx.skins.halo
{
   ...
   public class SwatchSkin extends UIComponent
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         this.mx_internal::updateSkin(this.mx_internal::color);
      }
      ...
      mx_internal function updateGrid(param1:IList) : void
      {
         ...
         {
            graphics.clear();
            this.drawGrid(param1,this.mx_internal::colorField);
         }
      }
      ...
      mx_internal function updateSkin(param1:Number) : void
      {
         ...
         switch(name)
         {
            case "colorPickerSwatch":
               ...
               {
                  _loc3_ /= Math.abs(UIComponent(parent).scaleX);
                  _loc4_ /= Math.abs(UIComponent(parent).scaleY);
               }
               _loc2_.clear();
      ...
      private function drawGrid(param1:IList, param2:String) : void
      {
         ...
         while(_loc21_ < _loc14_)
         {
            ...
            _loc24_ = typeof param1.getItemAt(_loc21_) != "object" ? Number(param1.getItemAt(_loc21_)) : Number(param1.getItemAt(_loc21_)[this.mx_internal::colorField]);
