package spark.components.supportClasses
{
   ...
   public class TouchScrollHelper
   {
      ...
      private function sbRoot_mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         if(!this.isScrolling)
         {
            ...
            if(_loc3_)
            {
               ...
               _loc4_.relatedObject = this.mx_internal::target;
               ...
               _loc6_.relatedObject = this.mx_internal::target;
      ...
      private function sbRoot_mouseUpHandler(param1:Event) : void
      {
         ...
         var _loc3_:Number = 0;
         var _loc4_:int = this.mouseEventLength > EVENT_HISTORY_LENGTH ? EVENT_HISTORY_LENGTH : int(this.mouseEventLength);
      ...
      private function calculateThrowVelocity() : Point
      {
         ...
         var _loc1_:int = this.mouseEventLength > EVENT_HISTORY_LENGTH ? EVENT_HISTORY_LENGTH : int(this.mouseEventLength);
      ...
      private function calculateFinalDragVelocity(param1:Number) : Point
      {
         ...
         var _loc2_:int = this.mouseEventLength > EVENT_HISTORY_LENGTH ? EVENT_HISTORY_LENGTH : int(this.mouseEventLength);
      ...
      private function dispatchBubblingEventOnMouseDownedDisplayObject(param1:Event) : Boolean
      {
         ...
         {
            _loc2_ &&= this.mouseDownedDisplayObject.dispatchEvent(param1);
            if(!this.mouseDownedDisplayObject.stage)
            {
               ...
               {
                  _loc2_ &&= this.mx_internal::target.dispatchEvent(param1);
               }
            }
         }
         else
