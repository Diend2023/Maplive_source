package spark.layouts.supportClasses
{
   ...
   public final class LinearLayoutVector
   {
      ...
      public function insert(param1:uint) : void
      {
         ...
         {
            _loc2_ = int(this.pendingInserts.length - 1);
      ...
      public function remove(param1:uint) : void
      {
         ...
         if(this.pendingRemoves)
         {
            _loc2_ = int(this.pendingRemoves.length - 1);
         ...
         this.pendingLength = this.pendingLength == -1 ? int(this.length - 1) : this.pendingLength - 1;
         if(!this.pendingRemoves)
         {
      ...
      private function inBlockCopy(param1:Block, param2:int, param3:Block, param4:int, param5:int) : void
      {
         ...
         var _loc7_:int = _loc6_ ? param4 : param4 + param5 - 1;
      ...
      private function copyInterval(param1:int, param2:int, param3:int) : void
      {
         ...
         while(param3 > 0)
         {
            ...
            _loc12_ = _loc4_ ? int(_loc6_) : _loc6_ - _loc11_ + 1;
            _loc13_ = _loc4_ ? int(_loc9_) : _loc9_ - _loc11_ + 1;
      ...
      public function start(param1:uint) : Number
      {
         ...
         var _loc7_:uint = uint(param1 - _loc6_);
         if(_loc5_)
         {
            _loc9_ = _loc5_.sizes;
            _loc4_ = 0;
